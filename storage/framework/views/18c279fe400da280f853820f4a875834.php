      ...
      <div class="py-5 items-center flex flex-col h-[100vh]">
          ...
          <div class="justify-center items-center flex flex-col sm:w-9/12  ">
              <ul class="justify-center items-center flex flex-wrap w-full gap-2">
                ...
                ?>
                <?php $__currentLoopData = $new_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('home.filterByCategory', ['categoryName'=>$item->cat_name])); ?>">
                  <li class="border border-gray-800 font-bold rounded-3xl px-4 py-1 hover:bg-teal-600 hover:text-white hover:shadow-lg text-[17px]"><?php echo e($item->cat_name); ?></li>
                </a>
          ...
          <div class="flex w-9/12 py-10">
            ...
            <form action="<?php echo e(route('home')); ?>" method="Get" enctype="multipart/form-data" class="w-full">   
...
</html><?php /**PATH C:\Users\lpy\Desktop\MovieBlog_YT\resources\views/layout/base.blade.php ENDPATH**/ ?>